...
public class messageHandler {
	private static OkHttpClient client = new OkHttpClient();
	 ...
	 private static String LINE_TOKEN;
	 public static void doAction(JSONObject event) {
	 ...
	 private static void text(String replyToken, String text) {
	 ...
	 private static void sticker(String replyToken, String packageId, String stickerId) {
	  JSONObject body = new JSONObject();
	  JSONArray messages = new JSONArray();
	  JSONObject message = new JSONObject();
	 ...
	 public static void sendLinePlatform(JSONObject json) {
